    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-bg-card rounded-2xl shadow-2xl border border-border-main w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="px-6 py-4 border-b border-border-main flex items-center justify-between bg-bg-main/50">
          <h2 className="font-heading text-lg font-bold text-text-main">Editar Cliente</h2>
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-bg-main border border-border-main text-text-main rounded-xl focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all"
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2.5 border border-border-main rounded-xl text-sm font-semibold text-text-main hover:bg-bg-main transition-colors"
            >
              Cancelar
            </button>
            <button
              type="submit"
              className="flex-1 px-4 py-2.5 bg-brand text-white rounded-xl text-sm font-bold hover:bg-brand-dark transition-colors shadow-sm"
            >
              Salvar Alterações
            </button>
          </div>
